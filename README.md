...
## User registration system, developed during studies on Java EE ecosystem and web technologies, using HTML5, JSP, CSS3.
...
- [x] User CRUD
- [x] Product CRUD
- [x] Upload Image on server
- [x] Download image
- [x] Search user by filter
